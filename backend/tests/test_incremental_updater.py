# as it is related to the day 25 that i don't want to run.
# so i am commenting out it otherwise the code is correct

# To verify in day 25 no syntax errors without executing: 
from src.graph.incremental_updater import IncrementalUpdater; print('Import OK') # remove it when running the below code really in your system
